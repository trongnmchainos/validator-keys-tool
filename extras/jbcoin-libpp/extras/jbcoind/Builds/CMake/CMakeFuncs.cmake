# This is a set of common functions and settings for jbcoind
...
macro(use_protobuf)
  ...
  file(GLOB jbcoin_proto src/jbcoin/proto/*.proto)
  PROTOBUF_GENERATE_CPP(PROTO_SRCS PROTO_HDRS ${jbcoin_proto})

  if (WIN32)
    include_directories(src/protobuf/src
      src/protobuf/vsprojects
      ${CMAKE_CURRENT_BINARY_DIR}/src/jbcoin/proto)
  endif()
...
macro(setup_build_boilerplate)
  ...
  if (static)
    ...
    # set_target_properties(jbcoin-libpp PROPERTIES LINK_SEARCH_START_STATIC 1)
    # set_target_properties(jbcoin-libpp PROPERTIES LINK_SEARCH_END_STATIC 1)
  endif()
endmacro()
