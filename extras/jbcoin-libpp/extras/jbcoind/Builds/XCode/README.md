...
functionality used in the jbcoind repository, we suggest Git version 1.8.3.2 or
later.
...
should satisfy the cmake minimum version requirement for jbcoind.
...
Building jbcoind on osx requires `protoc` version 2.5.x or 2.6.x (later versions
do not work with jbcoind at this time).
...
[GitHub](https://github.com/jbcoin/jbcoind/releases GitHub).
