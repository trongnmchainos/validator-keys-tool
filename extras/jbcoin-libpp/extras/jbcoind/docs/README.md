...
3. Download [Boost](http://www.boost.org/users/download/)
  ...
  3. `./bootstrap.bat`
  4. (Optional, if you also plan to build jbcoind) `./bjam.exe --toolset=msvc-14.0
...
2. Install [Boost](http://www.boost.org/users/download/)
  ...
  2. Open a command prompt or shell in the `$BOOST_ROOT`.
  3. `$ ./bootstrap.bat`
  4. (Optional, if you also plan to build jbcoind)
...
1. Open a shell in your jbcoind root folder.
